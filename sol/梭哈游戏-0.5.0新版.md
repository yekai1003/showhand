...
contract showhand {
    ...
    function bringIn() public payable {
        require( round == 0);
        require( msg.sender == guestPlayer || msg.sender == hostPlayer );
        require( msg.value == bringInBet );
        //总账记录
    ...
    function bet() public payable {
        require(msg.value >= minmalBet);
        require(msg.sender == activePlayer);
        require(round > 0 && !isGameFinished);
